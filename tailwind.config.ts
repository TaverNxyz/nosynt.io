	...
	theme: {
		...
		extend: {
			colors: {
				...
				'security-amber': 'hsl(var(--security-amber))',
			...
			keyframes: {
				...
				'pulse-glow': {
					...
					'50%': { boxShadow: '0 0 40px hsl(var(--cyber-purple) / 0.5), 0 0 60px hsl(var(--cyber-blue) / 0.3)' }
				},
				'slide-in-bottom': {
					'0%': { 
			...
			animation: {
				...
				'cosmic-orbit': 'cosmic-orbit 20s linear infinite',
